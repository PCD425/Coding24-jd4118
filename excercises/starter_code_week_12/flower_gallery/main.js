...
// 2. loop through the flowers if array of objects
flowers.forEach(flower => {
    console.log(flower)
    const li = document.createElement('li');
    // li.classList()xxxx 这一行回去看看
...
// 4. create a new img of element for each flower

// 5. set the scr attribute of the img element to the image property of he flower object
